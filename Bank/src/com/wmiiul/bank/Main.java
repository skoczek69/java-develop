...
public class Main {
	...
	public static void main(String[] args) {
		...
		jacek.doTransaction(TransactionEnum.DEPOSIT, "12345678901234567890123456", 800.0, "Zaplata za monitor");

		jacek.doTransaction(TransactionEnum.CHECK, "12345678901234567890123456", 450.0, "Zaplata za telefon");
		...
		jacek.doTransaction(TransactionEnum.DEPOSIT, "12345678901234567890123456", 300.0, "Zaplata za klawiature");

		jacek.doTransaction(TransactionEnum.CHECK, "12345678901234567890123456", 160.0, "Rekompensata za pomoc");
		...
		hans.doTransaction(TransactionEnum.WIREOUT, "12345678901234567890123456", 100.0, "Payment for keyboard", "Polska",
				"ABCDEFGH");
		jacek.doTransaction(TransactionEnum.DEPOSIT, "12345678901234567890123456", 100.0, "Payment for keyboard");

		jacek.doTransaction(TransactionEnum.WIREOUT, "12345678901234567890123456", 200.0, "Payment for printer", "Polska",
				"ABCDEFGH");
		...
		hans.doTransaction(TransactionEnum.WIREOUT, "12345678901234567890123456", 300.0, "Payment for computer game", "Polska",
				"ABCDEFGH");
		jacek.doTransaction(TransactionEnum.DEPOSIT, "12345678901234567890123456", 300.0, "Payment for computer game");
